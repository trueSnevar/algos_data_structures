...
Несмотря на то, что дополнительная память
при забиении входного массива не используется, 
рекурсия использует стек вызовов, 
поэтому в среднем пространственная сложность 
составит О(log(n)), а при неудачном разбиении
может достигать и O(n).
